...
public class CountryFragment extends Fragment {
    ...
    private void loadAustralia() {
        countryModels.add(new CountryModel("https://flagi-1.ru/wp-content/webp-express/webp-images/uploads/2016/10/fj-1-580x290.png.webp", "Fiji"));
        countryModels.add(new CountryModel("https://flagi-1.ru/wp-content/webp-express/webp-images/uploads/2016/10/to-1-580x290.png.webp", "Tonga"));
